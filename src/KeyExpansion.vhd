...
architecture Behavioral of KeyExpansion is
    ...
    type rcon_array_t is array (1 to 10) of std_logic_vector(31 downto 0);
    ...
    begin
        ...
        for i in 4 to 43 loop
            ...
            if (i mod 4 = 0) then
                ...
                temp(31 downto 24) := SBOX(to_integer(unsigned(temp(31 downto 24))));
                temp(23 downto 16) := SBOX(to_integer(unsigned(temp(23 downto 16))));
                temp(15 downto 8)  := SBOX(to_integer(unsigned(temp(15 downto 8))));
                temp(7 downto 0)   := SBOX(to_integer(unsigned(temp(7 downto 0))));
        ...
        for j in 0 to 10 loop
            round_keys((10-j)*128 + 127 downto (10-j)*128) <= W(j*4) & W(j*4+1) & W(j*4+2) & W(j*4+3);
        end loop;
    end process;
end Behavioral;